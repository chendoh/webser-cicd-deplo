...
var BU=$rt_throw;var Cn=$rt_compare;var Co=$rt_nullCheck;var BW=$rt_cls;var Ch=$rt_createArray;var Cp=$rt_isInstance;var Cq=$rt_nativeThread;var Cr=$rt_suspending;var Cs=$rt_resuming;var Ct=$rt_invalidPointer;var D=$rt_s;var BH=$rt_eraseClinit;var Cu=$rt_imul;var Cv=$rt_wrapException;var Cw=$rt_checkBounds;var Cx=$rt_checkUpperBound;var Cy=$rt_checkLowerBound;var Cz=$rt_wrapFunction0;var CA=$rt_wrapFunction1;var CB=$rt_wrapFunction2;var CC=$rt_wrapFunction3;var CD=$rt_wrapFunction4;var C=$rt_classWithoutFields;var CE
...
var Bx=C();
function Ci(b){var c,d,e;BC();Bw();BK();c=$rt_globals.window.document;d=c.createElement("div");e=c.createTextNode("TeaVM generated element");d.appendChild(e);c.body.appendChild(d);}
var Ba=C(0);
var Br=C(0);
...
var C3=null;function Cg(a){var b=new O();BB(b,a);return b;}
...
function BE(a,b){var c,d,e,f,g;c=a.a.data.length;if(c>=b)return;d=c>=1073741823?2147483647:BA(b,BA(c*2|0,5));e=a.a.data;f=U(d);b=e.length;if(d<b)b=d;g=f.data;c=0;while(c<b){g[c]=e[c];c=c+1|0;}a.a=f;}
var Bu=C(0);
var Bb=C(R);
function Bp(a,b){var c,d,e,f,g;c=a.c;if(b===null)b=D(2);if(c>=0&&c<=c){if(!(b.b.data.length?0:1)){BE(a,c+G(b)|0);d=a.c-1|0;while(d>=c){a.a.data[d+G(b)|0]=a.a.data[d];d=d+(-1)|0;}a.c=a.c+G(b)|0;e=0;while(e<G(b)){f=a.a.data;g=c+1|0;f[c]=V(b,e);e=e+1|0;c=g;}}return a;}BU(BZ());}
var K=C(H);
var BL=C(K);
...
var Z=C(X);
var BG=C(Z);
function BZ(){var a=new BG();Cc(a);return a;}
function Cc(a){a.g=1;a.f=1;}
var BI=C();
function BA(b,c){if(b>c)c=b;return c;}
var BN=C();
$rt_packages([]);
$rt_metadata([B,0,0,[],0,3,0,0,0,Bx,0,B,[],0,3,0,0,0,Ba,0,B,[],3,3,0,0,0,Br,0,B,[],3,3,0,0,0,Bq,0,B,[Ba,Br],0,3,0,0,0,BO,0,B,[],4,0,0,0,0,BF,0,B,[],4,3,0,0,0,L,0,B,[],3,3,0,0,0,M,0,B,[],3,3,0,0,0,P,0,B,[],3,3,0,0,0,O,0,B,[L,M,P],0,3,0,0,0,J,0,B,[],0,3,0,0,0,Q,0,J,[],0,3,0,0,0,H,0,Q,[],0,3,0,0,0,BD,0,H,[],0,3,0,0,0,S,0,B,[L],1,3,0,0,0,Bi,0,S,[M],0,3,0,0,0,R,0,B,[L,P],0,0,0,0,0,Bu,0,B,[],3,3,0,0,0,Bb,0,R,[Bu],0,3,0,0,0,K,0,H,[],0,3,0,0,0,BL,0,K,[],0,3,0,0,0,BM,0,K,[],0,3,0,0,0,W,0,J,[],0,3,0,0,0,X,0,W,[],0,3,
0,0,0,I,0,B,[],3,3,0,0,0,Bg,0,B,[I],3,3,0,0,0,Bn,0,B,[Bg],3,3,0,0,0,F,0,B,[I],3,3,0,0,0,Bz,0,B,[Bn,F],3,3,0,0,0,BJ,0,B,[],4,3,0,0,0,Bm,0,B,[F],3,3,0,0,0,Bj,0,B,[F],3,3,0,0,0,Bt,0,B,[F],3,3,0,0,0,Bc,0,B,[F],3,3,0,0,0,Bv,0,B,[F],3,3,0,0,0,Bd,0,B,[F,Bm,Bj,Bt,Bc,Bv],3,3,0,0,0,Bs,0,B,[],3,3,0,0,0,Bk,0,B,[I],3,3,0,0,0,BQ,0,B,[I,Bd,Bs,Bk],1,3,0,0,["x",CB(BY),"L",CB(BR),"M",CA(B3),"A",CC(B_),"r",CA(BX),"E",Cz(BV),"B",CC(BT)],Bo,0,B,[],3,3,0,0,0,Bh,0,B,[Bo],0,3,0,0,0,N,0,B,[M],0,3,0,0,0,Z,0,X,[],0,3,0,0,0,BG,0,Z,[],
